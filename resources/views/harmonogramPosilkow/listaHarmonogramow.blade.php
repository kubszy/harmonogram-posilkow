...
@section('title', 'Lista harmonogramów - Harmonogram posiłków')
...
@if ($straconeKg != 0) <h3 style="padding-bottom: 20px;" class="alert alert-success">Waga spadła o {{ $straconeKg }} kg</h3>@endif
